...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    'sw-precache': {
      ...
      default: {
        staticFileGlobs: [
          '*.{ico,png,txt,html,json,js,xml,webmanifest}',
          'images/{,*/}*',
          'fonts/{,*/}*',
          'scripts/{,*/}*',
          'styles/{,*/}*'
      ...
      develop: {
        staticFileGlobs: ['fonts/**/*.{woff,ttf,svg,eot}']
      }
    },
    ...
    manifest: {
      generate: {
        ...
        src: [
          '*.{ico,txt,html,json,js,webmanifest}',
          'images/*.*',
          'fonts/*.*',
          'scripts/*.*',
          'styles/*.*'
    ...
    copy: {
      dist: {
        files: [{
            ...
            dest: '<%= yeoman.dist %>',
            src: [
              '*.{ico,png,txt,json,js,webmanifest}',
              '.htaccess',
              '*.html',
              '*.manifest',
              '*.xml',
    ...
    ngconstant: {
      ...
      development: {
        ...
        constants: {
          ENV: {
            name: 'development',
            apiEndpoint: 'https://dev-sterna.estaleiro.serpro.gov.br/geo/'
          }
        }
      },
      production: {
