...
app.controller('DomingoController', [
  '$q',
  '$scope',
  '$rootScope',
  '$routeParams',
    ...
    $scope.findAuxiliar = function () {
      $q
        ...
        .then(function (result) {
          ...
          $scope.updateMarker(result[1], 'book', 'blue');
          $scope.updateMarker(result[2], 'book', 'orange');
          $scope.updateMarker(result[3], 'book', 'red');
        });
    };
    ...
    if (path === '/domingo') {
      angular.extend($scope, {
        ...
        legend: {
          ...
          labels: ['Cinema', 'Teatro', 'Sanduba', 'Estação Ônibus']
        },
        layers: {
          baselayers: {
            preload: Infinity,
